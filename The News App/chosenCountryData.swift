...
struct ChosenCountryData {
    ...
    var countryDataArray = [ChosenCountryObject(countryCodeInit: "AE", countryNameInit: "United Arab Emirates", imageInit: UIImage(named: "uae")!),
                            ...
                            ChosenCountryObject(countryCodeInit: "SE", countryNameInit: "Sweden", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "SG", countryNameInit: "Singapore", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "SI", countryNameInit: "Slovenia", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "SK", countryNameInit: "Slovakia", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "TH", countryNameInit: "Thailand", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "TR", countryNameInit: "Turkey", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "TW", countryNameInit: "Taiwan", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "UA", countryNameInit: "Ukraine", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "US", countryNameInit: "United States", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "VE", countryNameInit: "Venezuela(Bolivarian Republic of)", imageInit: UIImage(named: "cza")!),
                            ChosenCountryObject(countryCodeInit: "ZA", countryNameInit: "Zambia", imageInit: UIImage(named: "cza")!),
